...
//! Project version number for TFAlerView.
FOUNDATION_EXPORT double TFAlerViewVersionNumber;

//! Project version string for TFAlerView.
FOUNDATION_EXPORT const unsigned char TFAlerViewVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <TFAlerView/PublicHeader.h>
