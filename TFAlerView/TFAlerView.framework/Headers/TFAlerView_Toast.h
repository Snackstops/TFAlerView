...
@interface TFAlerView_Toast : NSObject
 ...
 */
+ (void)showToastWithTitle:(NSString *)title message:(NSString *)message iconImage:(UIImage*)iconImage duration:(NSTimeInterval)duration toastType:(TFToastType)toastType;
